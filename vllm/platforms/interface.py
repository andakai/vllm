...
if TYPE_CHECKING:
    ...
    from vllm.v1.core.kv_cache_plan import KVCachePlanner
else:
...
class Platform:
    ...
    @classmethod
    def get_kv_cache_planner(
        cls,
        vllm_config: "VllmConfig",
        delegate: "KVCachePlanner",
    ) -> "KVCachePlanner":
        """Return, wrap, or replace the model-aware KV cache planner."""
        return delegate

...
if TYPE_CHECKING:
    ...
    from vllm.v1.core.kv_cache_utils import KVCachePlanningPolicy
else:
...
class Platform:
    ...
    @classmethod
    def get_kv_cache_planning_policy(
        cls, vllm_config: "VllmConfig"
    ) -> type["KVCachePlanningPolicy"] | None:
        """Return a platform-specific KV cache planning policy, if any."""
        return None

...
class Glm5NextKVCachePlanProvider(KVCachePlanProvider):
    def get_group_plan(self, vllm_config, kv_cache_specs):
        if (
            ...
            return super().get_group_plan(vllm_config, kv_cache_specs)
        plan = _get_glm5_group_plan(vllm_config, kv_cache_specs)
        return plan or super().get_group_plan(vllm_config, kv_cache_specs)
    ...
    def get_worker_plan(self, vllm_config, kv_cache_groups):
        ...
        return RegionWorkerPlan(kv_cache_groups, tuple(regions))
